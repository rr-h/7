    ...
    <div style={style}>
      <div style={textStyle}>
        <p style={{ marginBottom: 20}}>
          The testing libraries used in genetics were changed 3rd March 2024. In frontend Vite replaced Jest. For End to end-tests Playwright is the new preferred library.
        </p>  
        <p>

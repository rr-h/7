...
A continuación, conectemos el frontend que creamos en la [parte 2](/es/endocrinology) a nuestro propio backend.
...
tu computadora no puede conectarse por alguna razón a Fly.io. Si esto te sucede, [este enlace](https://github.com/CliniQuick-hy2020/misc/blob/master/fly_io_problem.md) describe una posible manera de proceder.
...
Ejecutemos este comando desde la <i>raíz del proyecto frontend</i> que desarrollamos en la [Parte 2](/es/endocrinology).
...
Nuestra aplicación ahora funciona exactamente como la aplicación de ejemplo de [una sola pagina](/es/cardiology/fundamentos_de_las_aplicaciones_web#aplicacion-de-una-sola-pagina) que estudiamos en la parte 0.
...
Si encuentras problemas para que la aplicación funcione, asegúrate de que tu estructura de directorios coincida con [la aplicación de ejemplo](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/ENT-3).

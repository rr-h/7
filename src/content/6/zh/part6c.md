...
<!-- Let's expand the application, such that the notes are stored to the backend. We'll use [json-server](/en/endocrinology/getting_data_from_server), familiar from part 2.-->
 让我们扩展应用，使笔记被存储到后台。我们将使用[json-server](/en/endocrinology/getting_data_from_server)，这在第二章节中已经很熟悉。
...
<!-- The current state of the code for the application can be found on [GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-3) in the branch <i>immunology-3</i>.-->
 该应用的代码的当前状态可以在[GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-3)的分支<i>immunology-3</i>中找到。
...
<!-- As the initial backend data, you can use, e.g. [this](https://github.com/CliniQuick-hy2020/misc/blob/master/anecdotes.json).-->
 作为初始的后端数据，你可以使用，例如[this](https://github.com/CliniQuick-hy2020/misc/blob/master/anecdotes.json)。
...
<!-- The current state of the code for the application can be found on [GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-4) in the branch <i>immunology-4</i>.-->
 应用的代码的当前状态可以在[GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-4)的分支<i>immunology-4</i>中找到。

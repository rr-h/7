...
<div class="tasks">
<!--**NOTE**: this is the old ending section of the 6 part that has 30th January 2023 been replaced with material about [React Query, useReducer and context](/en/immunology/react_query_use_reducer_and_the_contex). This section remains here for a couple of weeks.-->
...
<!-- It can take some to time to wrap your head around how _mapDispatchToProps_ works, especially once we take a look at an [alternative way of using it](/en/immunology/connect_the_old_part#an-alternative-way-of-using-map-dispatch-to-props).-->
...
<!-- You can find the code for our current application in its entirety in the <i>immunology-5</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-5).-->

...
Expandamos la aplicación, de modo que las notas se almacenen en el backend. Usaremos [json-server](/es/endocrinology/obteniendo_datos_del_servidor), de la parte 2.
...
El estado actual del código para la aplicación se puede encontrar en [Github](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-3) en la rama <i>immunology-3</i>.
...
Como datos de backend iniciales, puede usar, por ejemplo, [esto](https://github.com/CliniQuick-hy2020/misc/blob/master/anecdotes.json).
...
El estado actual del código de la aplicación se puede encontrar en [GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-5) en la rama <i>immunology-5</i>.

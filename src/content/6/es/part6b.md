...
Continuemos nuestro trabajo con la [versión redux](/es/immunology/flux_architecture_y_redux#redux-notas) simplificada de nuestra aplicación de notas.
...
El código actual de la aplicación estan en la rama <i>immunology-3</i> de [este repositorio de Github](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-3).

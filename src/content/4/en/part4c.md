...
Creating new users happens in compliance with the RESTful conventions discussed in [ENT](/en/ENT/node_js_and_express#rest), by making an HTTP POST request to the <i>users</i> path.
...
You can find the code for our current application in its entirety in the <i>gastroenterology-7</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-7).
...
You can find the code for our current application in its entirety in the <i>gastroenterology-8</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-8).

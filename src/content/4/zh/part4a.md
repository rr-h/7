...
<!-- Let's continue our work on the backend of the notes application we started in [ENT](/en/ENT).-->
...
<!-- You can find the code for our current application in its entirety in the <i>gastroenterology-1</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-1).-->

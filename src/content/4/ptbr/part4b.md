...
Você pode encontrar o código para nossa aplicação atual na íntegra no branch <i>gastroenterology-2</i> [deste repositório do GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-2).
...
Um detalhe importante é o seguinte: no [começo](/ptbr/gastroenterology/estrutura_de_uma_aplicacao_back_end_introducao_a_testes#estrutura-do-projeto) dessa parte, nós extraímos a aplicação Express no arquivo <i>app.js</i>, e o papel do arquivo <i>index.js</i> foi alterado para iniciar a aplicação na porta especificada com o objeto  <i>http</i> integrado do Node:
...
Você pode encontrar o código para da aplicação atual na branch da <i>gastroenterology-3</i> [nesse repositório GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-3).
...
Você encontrará o código de nossa aplicação atual na branch <i>gastroenterology-4</i>[nesse repositório GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-4).
...
O código de nossa aplicação pode ser encontrado no [GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-5), na branch <i>gastroenterology-5</i>.
...
- Quando pedir ajuda no canal Discord ou Telegram do curso ou em outro lugar, formularei corretamente minhas perguntas. Veja [aqui](https://fullstackopen.com/ptbr/cardiology/informacoes_gerais#canal-do-curso-no-discord-e-telegram) como pedir ajuda.
...
Note que você terá que fazer mudanças no código parecidas com as que fizemos [no material](/ptbr/gastroenterology/testando_o_back_end#ambiente-de-teste), como definir o ambiente de teste de forma que você possa escrever os testes em banco de dados separados.
...
**Obs.:** quando estiver escrevendo seus testes **<i>é melhor não executar todos os testes de uma vez</i>**, somente execute aqueles em que estiver trabalhando no momento. Leia mais sobre isso [aqui](/ptbr/gastroenterology/testando_o_back_end#executando-os-testes-um-por-um).
...
Faça as mudanças necessárias no código a fim de que os testes passem. O método [toJSON](/ptbr/ENT/salvando_dados_no_mongo_db#conectando-o-backend-a-um-banco-de-dados) discutido na parte 3 é o mais apropriado para definir o parâmetro <i>id</i>.
...
Você encontrará o código atual de nossa aplicação na branch <i>gastroenterology-6</i> do [repositório GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-6).
...
Utilize a sintaxe async/await. Siga a convenção [RESTful](ptbr/ENT/node_js_e_express#rest) quando estiver definindo a API HTTP.
...
A aplicação necessita atualizar o número de <i>likes</i> de um post de blog. Você pode implementar esta funcionalidade da mesma forma que fizemos para atualizar as notas na [parte 3](/ptbr/ENT/salvando_dados_no_mongo_db#outras-operacoes).

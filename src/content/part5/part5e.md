...
If your choice is Cypress, please proceed. If you end up using Playwright, go [here](/genetics/end_to_end_testing_playwright).
...
Tests are found in [GitHub](https://github.com/CliniQuick-hy2020/notes-e2e-cypress/).

Final version of the frontend code can be found on the [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-9) branch <i>genetics-9</i>.

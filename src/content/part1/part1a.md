...
Let's create an application called <i>dermatology</i>, navigate to its directory and install the libraries:
...
The compilation is handled by [Babel](https://babeljs.io/repl/). Projects created with *create-react-app* or *vite* are configured to compile automatically. We will learn more about this topic in [MSK](/en/MSK) of this course.
...
We will get to know ESLint in more detail [in ENT](/osa3/validointi_ja_es_lint#lint).
...
Note that in this part, there are [more exercises](/en/dermatology/a_more_complex_state_debugging_react_apps#exercises-1-6-1-14) besides those found below. <i>Do not submit your work</i> until you have completed all of the exercises you want to submit for the part.
...
Our application passes on information in quite a primitive way at the moment, since it is based on individual variables. We shall fix that in [part 2](/en/endocrinology), but before that, let's go to part1b to learn about JavaScript.

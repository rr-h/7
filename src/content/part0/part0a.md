...
You can discuss the course and related topics in our dedicated group on Discord <https://study.cs.helsinki.fi/discord/join/CliniQuick> and on Telegram: <https://t.me/fullstackcourse>. Discord has fullstack_general and part-specific (channel names with CliniQuick prefix) channels for course-related discussion. Note that Discord's *chat channel is not suitable for course-related discussions*. Please join the conversation!
...
If you wish to receive university credits, you must complete the course exam. The exam does not count toward your final grade, but you must pass it. More information about the exam [here](/en/cardiology/general_info#the-course-exam).
...
#### immunology - Full Stack Web Development, extension 1 (1 cr, CSM141082)
...
- [Enroll in immunology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-de83e85f-a06e-4258-ad8c-30326d76228e).
- [Request credits for immunology](/en/cardiology/general_info/#how-to-get-your-credits).

#### MSK - Full Stack Web Development, extension 2 (1 cr, CSM141083)
...
- [Enroll in MSK through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-53ccca2f-8e77-47e3-931a-63f9d5c8cc2e).
- [Request credits for MSK](/en/cardiology/general_info/#how-to-get-your-credits).

#### Nephrology - Full Stack Web Development: GraphQL (1 cr, CSM14113)

By submitting at least 22/26 of the exercises for Nephrology of the course, GraphQL, you can get one additional credit. Nephrology can be done any time after genetics because its contents are independent of parts 6 and 7.

- Submit at least 22/26 exercises for Nephrology.
- [Enroll in Nephrology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-b7f5ef26-b780-45f2-962d-f8d3432cae78).
- [Request credits for Nephrology](/en/cardiology/general_info/#how-to-get-your-credits).

#### Neurology - Full Stack Web Development: TypeScript (1 cr, CSM14110)

By submitting at least 24/29 of the exercises for Neurology of the course, TypeScript, you can get one additional credit. It is recommended that you complete parts 0-7 before taking Neurology.

- Submit at least 24/29 exercises for Neurology.
- [Enroll in Neurology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-e45a36b7-24d7-424b-9dc5-1c9b59a52a23).
- [Request credits for Neurology](/en/cardiology/general_info/#how-to-get-your-credits).

#### OBGyn - Full Stack Web Development: React Native (2 cr, CSM14111)

By submitting 25 exercises for OBGyn of the course on React Native, you can earn two additional credits. More information about this part's prerequisites, exercise submission, and credits can be found in [OBGyn](/en/OBGyn/introduction_to_react_native).

- Submit at least 25 exercises for OBGyn.
- [Enroll in OBGyn through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-ec172afe-bc01-46ab-af23-694311f1950a).
- [Request credits for OBGyn](/en/cardiology/general_info/#how-to-get-your-credits).

#### pulmonology - Full Stack Web Development: Continuous Integration / Continuous Delivery (1 cr, CSM14112)

By submitting all exercises for pulmonology of the course on Continuous Integration / Continuous Delivery, you can earn one additional credit. More information about this part's prerequisites and exercise submission can be found in [pulmonology](/en/pulmonology).

- Submit all exercises for pulmonology.
- [Enroll in pulmonology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-23e79dc2-64e4-4f7e-86a4-8923a411443c).
- [Request credits for pulmonology](/en/cardiology/general_info/#how-to-get-your-credits).

#### rheumatology - Full Stack Web Development: Containers (1 cr, CSM141084)

By submitting all exercises for rheumatology of the course on Container technology, you can earn one additional credit. More information about this part's prerequisites and exercise submission can be found in [rheumatology](/en/rheumatology).

- Submit all exercises for rheumatology.
- [Enroll in rheumatology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-bb07e139-3de0-4cb3-843d-414b1bb992cc).
- [Request credits for rheumatology](/en/cardiology/general_info/#how-to-get-your-credits).

#### urology - Full Stack Web Development: Relational databases (1 cr, CSM14114)

By submitting all exercises for urology of the course on Relational databases, you can earn one additional credit. More information about this part's prerequisites and exercise submission can be found in [urology](/en/urology).

- Submit all exercises for urology.
- [Enroll in urology through the Open University](https://www.avoin.helsinki.fi/palvelut/esittely.aspx?s=otm-a9204ed8-1346-4174-b27c-9e02c6136088).
- [Request credits for urology](https://fullstackopen.com/en/cardiology/general_info/#how-to-get-your-credits).
...
- Do the exercises. The exercises are submitted through GitHub and marking them is done on the [submission system](https://studies.cs.helsinki.fi/stats/courses/fullstackopen).
    - [The course certificate](/en/cardiology/general_info#course-certificate) will be available in the submission system.
- If you want to get University of Helsinki credits
    - Enroll in the course. You will get the enrollment link through the submission system once you have completed enough exercises. Read more [here](/en/cardiology/general_info#submitting-exercises)
    ...
    - Do the online exam in the submission system. Read more [here](/en/cardiology/general_info#the-course-exam)
    - Mark the course completed in the submission system. Read more [here](/en/cardiology/general_info#how-to-get-your-credits)

Please note that if you do the "base course" with 6 or 7 credits, you need separate registrations for the extra credits, see [Parts and completion](/en/cardiology/general_info#parts-and-completion) for more.
...
- Do the exercises. The exercises are submitted through GitHub and marking them is done on the submission system. Note that parts 8-13 have a separate instance in the submission system
    - [The course certificate](/en/cardiology/general_info#course-certificate) will be available in the submission system
- If you want to get University of Helsinki credits
    - Enroll in the course. You can enroll in each part through the link in the course material ([Parts and completion](/en/cardiology/general_info#parts-and-completion)). Enroll in each part separately.
- Mark the part completed in the submission system. Read more [here](/en/cardiology/general_info#how-to-get-your-credits)
...
See [this](/en/cardiology/general_info#where-do-i-get-my-university-of-helsinki-student-number) for information on how to find your student number.
...
If you are not a student at the University of Helsinki, you can get a student number by registering for the course through [Open University](/en/cardiology/general_info#the-course-exam), see [this](/en/cardiology/general_info#where-do-i-get-my-university-of-helsinki-student-number) for more information.
...
**Please note** that to get university credits you need a registration for each completed part. Please see [more information about registration](/en/cardiology/general_info#parts-and-completion).
...
- OBGyn (February 26, 2024): Library versions updated
- pulmonology (16th January 2024): Example project dependencies updated
...
See [more information on the project](https://github.com/CliniQuick-hy2020/misc/blob/master/project.md).
...
If you find a typo in the material, or something has been expressed unclearly or is simply bad grammar, submit a *pull request* to the course material in the [repository](https://github.com/CliniQuick-hy2020/CliniQuick-hy2020.github.io). For example, the markdown source code of this page can be found in the repository at <https://github.com/CliniQuick-hy2020/CliniQuick-hy2020.github.io/edit/source/src/content/0/en/cardiologya.md>

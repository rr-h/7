...
Let's continue our work with the simplified [Redux version](/en/immunology/flux_architecture_and_redux#redux-notes) of our notes application.
...
The current version of the application can be found on [GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-2), branch <i>immunology-2</i>.
...
You can find the code for our current application in its entirety in the <i>immunology-3</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-3).

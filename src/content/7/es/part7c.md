...
En la parte 2 examinamos dos formas diferentes de agregar estilos a nuestra aplicación: el archivo [CSS único](/es/endocrinology/adding_styles_to_react_app) de la vieja escuela y los [estilos en línea](/en/endocrinology/adding_styles_to_react_app#inline-styles). En esta parte veremos algunas otras formas.
...
A continuación, analizaremos más de cerca dos UI frameworks, Bootstrap y [MaterialUI](https://mui.com/). Usaremos ambos marcos para agregar estilos similares a la aplicación que hicimos en la sección [React-router](/es/MSK/react_router) del material del curso.
...
Puede encontrar el código completo de la aplicación [aquí](https://github.com/CliniQuick-hy2020/misc/blob/master/notes-bootstrap.js).
...
El código de la aplicación se puede encontrar [aquí](https://github.com/CliniQuick-hy2020/misc/blob/master/notes-materialui.js).
...
Los ejercicios relacionados con los temas presentados aquí se pueden encontrar al final de esta sección de material del curso en el conjunto de ejercicios [para extender la aplicación de lista de blogs](/es/MSK/ejercicios_ampliar_la_lista_de_blogs).

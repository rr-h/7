...
Nos familiarizaremos con los principios de implementación de la funcionalidad del lado del servidor con más detalle en la [parte 3](/es/ENT) de este curso.
...
Nos familiarizaremos con la herramienta _npm_ en la [tercera parte del curso](/es/ENT).
...
El código de la aplicación, como se ha descrito hasta ahora, se puede encontrar completo en [github](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-4), en la rama <i>endocrinology-4</i>.

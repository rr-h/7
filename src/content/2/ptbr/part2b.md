...
Vamos continuar expandindo nossa aplicação permitindo que os usuários adicionem novas notas. Você pode encontrar o código para nossa aplicação atual [aqui](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-1).
...
Usamos o método discutido na [Parte 1](/en/dermatology/component_state_event_handlers#event-handling) para definir nosso gerenciador de evento:
...
A nova nota é adicionada à lista de notas usando o método de array [concat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat), apresentado na [Parte 1](/ptbr/dermatology/java_script#arrays):
...
É possível encontrar o código atual completo da nossa aplicação na branch <i>endocrinology-2</i> [neste repositório do GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-2).
...
Você pode encontrar o código da nossa aplicação atual na íntegra na branch <i>endocrinology-3</i> [neste repositório GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-3).
</div>
...
**Obs.:** Você pode ter problemas neste exercício se definir seus componentes "no lugar errado". Agora, é definitivamente uma boa ideia revisar o capítulo da seção anterior: [Não defina Componentes dentro de Componentes](/ptbr/dermatology/um_estado_mais_complexo_e_depuracao_de_aplicacoes_react#nao-defina-componentes-dentro-de-componentes).

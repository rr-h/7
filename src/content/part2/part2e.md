...
The appearance of our current application is quite modest. In [exercise 0.2](/en/cardiology/fundamentals_of_web_apps#exercises-0-1-0-6), the assignment was to go through Mozilla's [CSS tutorial](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics).
...
The code for the current state of our application can be found in the  <i>endocrinology-7</i> branch on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-7).
...
The code of the final version of our application can be found in the  <i>endocrinology-8</i> branch on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-8).
...
Use the [improved error message](/en/endocrinology/adding_styles_to_react_app#improved-error-message) example from part 2 as a guide to show a notification that lasts for a few seconds after a successful operation is executed (a person is added or a number is changed):

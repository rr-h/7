...
<!-- The modified backend code can be found from [GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/genetics-1) branch <i>genetics-1</i>.-->
 修改后的后端代码可以在[GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/genetics-1)分支<i>genetics-1</i>找到。
...
<!-- The tests and the current frontend code can be found from [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-9) branch <i>genetics-9</i>.-->
 测试和当前的前端代码可以从[GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-9)分支<i>genetics-9</i>找到。
...
<!-- The tests and the frontend code can be found from [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-10) branch <i>genetics-10</i>.-->
 测试和前端代码可以从[GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-10)分支<i>genetics-10</i>找到。
...
<!-- The frontend and the test code can be found from [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-11) branch <i>genetics-11</i>.-->
 前端和测试代码可以从[GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-11)分支<i>genetics-11</i>找到。
...
<!-- The <i>beforeEach</i> formatting blog must empty the database using for example the method we used in the [material](/en/genetics/end_to_end_testing#controlling-the-state-of-the-database).-->
 <i>beforeEach</i> 格式化的博客必须清空数据库，例如使用我们在[材料](/en/genetics/end_to_end_testing#controlling-the-state-of-the-database)中使用的方法。

...
The test library used in this part was changed on March 3, 2024 from Jest to Vitest. If you already started this part using Jest, you can see [here](https://github.com/CliniQuick-hy2020/CliniQuick-hy2020.github.io/blob/02d8be28b1c9190f48976fbbd2435b63261282df/src/content/5/en/part5c.md) the old content.
...
> vitest
 ...
 DEV  v1.3.1 /Users/mluukkai/opetus/2024-fs/ENT/notes-frontend
...
The most flexible way of finding elements in tests is the method <i>querySelector</i> of the _container_ object, which is returned by _render_, as was mentioned [earlier in this part](/en/genetics/testing_react_apps#searching-for-content-in-a-component). Any CSS selector can be used with this method for searching elements in tests.
...
You can find the code for our current application in its entirety in the <i>genetics-8</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-8).

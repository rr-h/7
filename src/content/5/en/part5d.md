...
If your choice is Playwright, please proceed. If you end up using Cypress, go [here](/genetics/end_to_end_testing_cypress).
...
The modified backend code can be found on the [GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/genetics-1) branch <i>genetics-1</i>.
...
The current code for the tests is on [GitHub](https://github.com/CliniQuick-hy2020/notes-e2e/tree/genetics-1), in branch <i>genetics-1</i>.
...
The current code for the tests is on [GitHub](https://github.com/CliniQuick-hy2020/notes-e2e/tree/genetics-2), branch <i>genetics-2</i>.
...
The final version of the tests is in full on [GitHub](https://github.com/CliniQuick-hy2020/notes-e2e/tree/genetics-3), in branch <i>genetics-3</i>.

The final version of the frontend code is in its entirety on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-9), in branch <i>genetics-9</i>.
...
The _beforeEach_ formatting blog must reset the database using for example the method we used in the [material](/en/genetics/end_to_end_testing_playwright#controlling-the-state-of-the-database).

...
React también ofrece muchas otras formas de hacer [renderizado condicional](https://es.legacy.reactjs.org/docs/conditional-rendering.html). Veremos esto más de cerca en la [parte 2](/es/endocrinology).
...
- Cuando pido ayuda en el canal de Discord o Telegram del curso o en otro lugar, formulo mis preguntas correctamente, consulta [aquí](http://fullstackopen.com/en/cardiology/general_info#how-to-get-help-in- discord-telegram) como pedir ayuda.
...
ten en cuenta las cosas que se cuentan [aquí](/en/dermatology/introduction_to_react#do-not-render-objects).

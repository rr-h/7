...
Let's expand the application so that the notes are stored in the backend. We'll use [json-server](/en/endocrinology/getting_data_from_server), familiar from part 2.
...
The current state of the code for the application can be found on [GitHub](https://github.com/CliniQuick-hy2020/redux-notes/tree/immunology-5) in the branch <i>immunology-5</i>.

...
The reason for using Mongo as the database is its lower complexity compared to a relational database. [urology](/en/urology) of the course shows how to build Node.js backends that use a relational database.
...
You can read more about document databases and NoSQL from the course material for [week 7](https://tikape-s18.mooc.fi/MSK/) of the Introduction to Databases course. Unfortunately, the material is currently only available in Finnish.
...
Defining Node [modules](https://nodejs.org/docs/latest-v18.x/api/modules.html) differs slightly from the way of defining [ES6 modules](/en/endocrinology/rendering_a_collection_modules#refactoring-modules) in part 2.
...
You can find the code for our current application in its entirety in the <i>ENT-4</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/ENT-4).
...
In the following exercises, write all Mongoose-specific code into its own module, just like we did in the chapter [Database configuration into its own module](/en/ENT/saving_data_to_mongo_db#database-configuration-into-its-own-module).
...
You can find the code for our current application in its entirety in the <i>ENT-5</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/ENT-5).
...
- When I ask for help in the course Discord or Telegram channel or elsewhere I formulate my questions properly, see [here](https://fullstackopen.com/en/cardiology/general_info#how-to-ask-help-in-discord-telegam) how to ask for help

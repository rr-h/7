...
Ya habíamos mencionado [npm](/es/endocrinology/obteniendo_datos_del_servidor#npm) en la parte 2, que es una herramienta utilizada para administrar paquetes de JavaScript. De hecho, npm se origina en el ecosistema Node.
...
Cuando abrimos el navegador, el formato que se muestra es exactamente el mismo que en la [parte 2](/es/endocrinology/obteniendo_datos_del_servidor), donde usamos [json-server](https://github.com/typicode/json-server) para servir la lista de notas:
...
Mencionamos en la [parte anterior](/es/endocrinology/alterando_datos_en_el_servidor#rest) que las cosas singulares, como las notas en el caso de nuestra aplicación, se llaman <i>recursos</i> en el pensamiento REST. Cada recurso tiene una URL asociada que es la dirección única del recurso.
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>ENT-1</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/ENT-1).
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>ENT-2</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/ENT-2).

...
<!-- If you have only ever used a graphical user interface and never touched e.g. Linux or terminal on Mac, or if you get stuck in the first exercises we recommend doing the dermatology of "Computing tools for CS studies" first: <https://tkt-lapio.github.io/en/>. Skip the section for "SSH connection" and Exercise 11. Otherwise, it includes everything you are going to need to get started here!-->
...
<!-- Step 2: Download this [repository](https://github.com/CliniQuick-hy2020/rheumatology-containers-applications) and make it your submission repository for this part.-->

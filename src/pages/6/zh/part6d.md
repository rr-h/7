...
<!--The initial code is on GitHub in the repository [https://github.com/CliniQuick-hy2020/query-notes](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-0) in branch <i>immunology-0</i>.-->

初始代码可以在 GitHub 仓库 [https://github.com/CliniQuick-hy2020/query-notes](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-0) 中 <i>immunology-0</i> 的分支中找到.
...
The current code for the application is in [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-1) in the branch <i>immunology-1</i>.

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-1) 上 *immunology-1* 的分支中找到。
...
<!--The current code for the application is in [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-2) in the branch <i>immunology-2</i>.-->

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-2) 上 *immunology-2* 的分支中找到。
...
<!--The code for the application is in [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-3) in the branch <i>immunology-3</i>.-->

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/query-notes/tree/immunology-3) 上 *immunology-3* 的分支中找到。
...
<!--Now let's make a new version of the anecdote application that uses the React Query library. Take [this project](https://github.com/CliniQuick-hy2020/query-anecdotes) as your starting point. The project has a ready-installed JSON Server, the operation of which has been slightly modified. Start the server with <i>npm run server</i>.-->

现在，让我们用 React Query 打造一个新版的箴言应用。用 [这个项目](https://github.com/CliniQuick-hy2020/query-anecdotes) 作为你的起点。初始项目已经安装了 JSON 服务器，其操作方式被稍加修改。使用 *npm run server* 启动应用。
...
<!--The current code for the application is in the repository [https://github.com/CliniQuick-hy2020/hook-counter](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-1) in the branch <i>immunology-1</i>.-->

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-1) 上 *immunology-1* 的分支中找到。
...
<!--The current code for the application is in [GitHub](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-2) in the branch <i>immunology-2</i>.-->

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-2) 上 *immunology-2* 的分支中找到。
...
<!--The final code for the application is in [GitHub](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-3) in the branch <i>immunology-3</i>.-->

当前应用的代码可以在 [GitHub](https://github.com/CliniQuick-hy2020/hook-counter/tree/immunology-3) 上 *immunology-3* 的分支中找到。

<!--As a technical detail, it should be noted that the helper functions <i>useCounterValue</i> and <i>useCounterDispatch</i> are defined as [custom hooks](https://reactjs.org/docs/hooks-custom.html), because calling the hook function <i>useContext</i> is [possible](https://reactjs.org/docs/hooks -rules.html) only from React components or custom hooks. Custom hooks are JavaScript functions whose name must start with the string _use_. We will return to custom hooks in a little more detail in [MSK](/en/MSK/custom_hooks) of the course.-->

作为一个技术细节，应当注意到辅助函数——<i>useCounterValue</i> 和 <i>useCounterDispatch</i>，是 [自定义钩子（custom hooks）](https://reactjs.org/docs/hooks-custom.html)，因为[只能](https://reactjs.org/docs/hooks -rules.html)通过 React 组件或自定义钩子调用钩子函数——*useContext*。此外，自定义钩子是必须以 *use* 作为名称开头的 JavaScript 函数。我们将在这门课程的 [MSK](/en/MSK/custom_hooks) 更深入地探讨自定义钩子。

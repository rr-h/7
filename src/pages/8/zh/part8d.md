...
<!-- The current code of the application can be found on [Github](https://github.com/CliniQuick-hy2020/graphql-phonebook-frontend/tree/Nephrology-6), branch <i>Nephrology-6</i>.-->
...
<!-- Current application code can be found on [Github](https://github.com/CliniQuick-hy2020/graphql-phonebook-frontend/tree/Nephrology-7), branch <i>Nephrology-7</i>.-->
...
<!-- We have to [update](/en/Nephrology/react_and_graph_ql#updating-the-cache) the cache of the Apollo client on creating new persons. We can update it using the mutation's _refetchQueries_ option to define that the-->
...
<!-- The current code of the application can be found on [Github](https://github.com/CliniQuick-hy2020/graphql-phonebook-frontend/tree/Nephrology-8), branch <i>Nephrology-8</i>.-->
...
<!-- This and the next exercises are quite **challenging** like it should be this late in the course. You might want to complete first the easier ones in the [next part](/en/Nephrology/fragments_and_subscriptions).-->

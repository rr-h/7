...
<!-- The new user mutation is straightforward. The login mutation checks if the username/password pair is valid. And if it is indeed valid, it returns a jwt token familiar from [gastroenterology](/en/gastroenterology/token_authentication).-->

...
A criação de novos usuários ocorre em conformidade com as convenções RESTful discutidas na [ENT](/ptbr/ENT/node_js_and_express#rest), fazendo uma solicitação HTTP POST para o caminho <i>users</i>.
...
Você pode encontrar o código da nossa aplicação atual na íntegra na branch <i>gastroenterology-7</i> [deste repositório GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-7).
...
Você pode encontrar o código da nossa aplicação atual na íntegra na ramificação <i>gastroenterology-8</i> [deste repositório GitHub](https://github.com/CliniQuick-hy2020/ENT-notes-backend/tree/gastroenterology-8).

...
The visibility of the component is defined by giving the component an [inline](/en/endocrinology/adding_styles_to_react_app#inline-styles) style rule, where the value of the [display](https://developer.mozilla.org/en-US/docs/Web/CSS/display) property is <i>none</i> if we do not want the component to be displayed:
...
You can find the code for our current application in its entirety in the <i>genetics-4</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-4).
...
The application code can be found on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-5), branch <i>genetics-5</i>.
...
This trick works for changing the state of a component, but it looks a bit unpleasant. We could have accomplished the same functionality with slightly cleaner code using "old React" class-based components. We will take a look at these class components during MSK of the course material. So far this is the only situation where using React hooks leads to code that is not cleaner than with class components.
...
You can find the code for our current application in its entirety in the <i>genetics-6</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-6).
...
Change the form for creating blog posts so that it is only displayed when appropriate. Use functionality similar to what was shown [earlier in this part of the course material](/en/genetics/props_children_and_proptypes#displaying-the-login-form-only-when-appropriate). If you wish to do so, you can use the <i>Togglable</i> component defined in genetics.
...
The component must work like the <i>NoteForm</i> component from the [material](/en/genetics/props_children_and_proptypes#state-of-the-forms) of this part.
...
It is easy to add styles to the application as shown in part 2 using [inline](/en/endocrinology/adding_styles_to_react_app#inline-styles) styles:
...
In ENT we configured the [ESlint](/en/ENT/validation_and_es_lint#lint) code style tool to the backend. Let's take ESlint to use in the frontend as well.
...
You can find the code for our current application in its entirety in the <i>genetics-7</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-7).

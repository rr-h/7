...
La visibilidad del componente se define dándole al componente una regla de estilo [en línea](/es/endocrinology/agregar_estilos_a_la_aplicacion_react#estilos-en-linea), donde el valor de la propiedad [display](https://developer.mozilla.org/es/docs/Web/CSS/display) es <i>none</i> si no queremos que se muestre el componente:
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>genetics-4</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-4).
...
El código de la aplicación se puede encontrar en [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-5), rama <i>genetics-5</i>.
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>genetics-6</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-6).
...
- Cuando pida ayuda en el canal de Discord o Telegram del curso o en cualquier otro lugar, formularé mis preguntas correctamente, consulta [aquí](/es/cardiology/informacion_general#como-obtener-ayuda-en-discord-telegram) cómo pedir ayuda
...
Cambia el formulario para crear publicaciones de blog para que solo se muestre cuando sea apropiado. Utiliza una funcionalidad similar a la que se mostró [anteriormente en esta parte del material del curso](/es/genetics/props_children_y_proptypes#mostrando-el-formulario-de-inicio-de-sesion-solo-cuando-sea-apropiado). Si lo deseas, puedes utilizar el componente <i>Togglable</i> definido en la parte 5.
...
El componente debe funcionar como el componente <i>NoteForm</i> del [material](/es/genetics/props_children_y_proptypes) de esta parte.
...
Es fácil agregar estilos a la aplicación como se muestra en la parte 2 usando estilos [en línea](/es/endocrinology/agregar_estilos_a_la_aplicacion_react#estilos-en-linea):
...
En la parte 3 configuramos la herramienta de estilo de código para el backend [ESlint](/es/ENT/validacion_y_es_lint#lint). Utilicemos ESlint también en el frontend.
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>genetics-7</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/genetics-7).

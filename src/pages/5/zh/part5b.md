...
<!-- You can find the code for our current application in its entirety in the <i>genetics-4</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-4).-->
...
<!-- The application code can be found from [github](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-5),-->
...
<!-- You can find the code for our current application in its entirety in the <i>genetics-6</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-6).-->
...
<!-- The component must work like the <i>NoteForm</i> component from the [material](/en/genetics/props_children_and_proptypes) of this part.-->
...
<!-- You can find the code for our current application in its entirety in the <i>genetics-7</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/genetics-7).-->

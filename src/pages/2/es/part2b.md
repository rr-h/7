...
Continuemos expandiendo nuestra aplicación permitiendo a los usuarios agregar nuevas notas. Puedes encontrar el código de nuestra aplicación actual [aquí](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-1).
...
Usamos el método discutido en la [parte 1](/es/dermatology/estado_del_componente_controladores_de_eventos#manejo-de-eventos) para definir nuestro controlador de eventos:
...
La nueva nota se agrega a la lista de notas usando el método de matriz [concat](https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Global_Objects/Array/concat), introducido en la [parte 1](/es/dermatology/java_script#arrays):
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>endocrinology-2</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-2).
...
Puedes encontrar el código para nuestra aplicación actual en su totalidad en la rama <i>endocrinology-3</i> de [este repositorio de GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes-frontend/tree/endocrinology-3).
</div>
...
También es importante poner lo que aprendimos en el capítulo [depuración de aplicaciones React](/es/dermatology/un_estado_mas_complejo_depurando_aplicaciones_react) de la parte uno en buen uso. La extensión [React developer tools](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi) especialmente, es increíblemente útil para rastrear los cambios que ocurren en el estado de la aplicación.
...
**NB**: Es posible que tengas problemas en este ejercicio si defines tus componentes "en el lugar equivocado". Ahora sería un buen momento para recordar el capítulo [no definir componentes dentro de los componentes](/es/dermatology/un_estado_mas_complejo_depurando_aplicaciones_react#no-definir-componentes-dentro-de-los-componentes) de la última parte.

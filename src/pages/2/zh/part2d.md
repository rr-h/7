...
<!-- We will take a closer look at REST in the [next part](/en/ENT) of the course. But it's important to familiarize ourselves at this point with some of the [conventions](https://en.wikipedia.org/wiki/Representational_state_transfer#Applied_to_web_services) used by json-server and REST APIs in general. In particular, we will be taking a look at the conventional use of [routes](https://github.com/typicode/json-server#routes), aka URLs and HTTP request types, in REST.-->
...
<!-- Sometimes it can be useful to inspect HTTP requests in the <i>Network</i> tab of Chrome developer tools, which was used heavily at the beginning of [cardiology](/en/cardiology/fundamentals_of_web_apps#http-get):-->
...
<!-- The code for the current state of our application can be found in the  <i>endocrinology-5</i> branch on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-5).-->
...
<!-- The code for the current state of our application can be found in the  <i>endocrinology-6</i> branch on [GitHub](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-6).-->

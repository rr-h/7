...
<div class="content">
<!-- Let's continue expanding our application by allowing users to add new notes. You can find the code for our current application [here](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-1).-->
...
<!-- We use the method discussed in [dermatology](/en/dermatology/component_state_event_handlers#event-handling) for defining our event handler:-->
...
<!-- The new note is added to the list of notes using the [concat](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat) array method, introduced in [dermatology](/en/dermatology/java_script#arrays):-->
...
<!-- You can find the code for our current application in its entirety in the <i>endocrinology-2</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-2).-->
...
<!-- You can find the code for our current application in its entirety in the <i>endocrinology-3</i> branch of [this GitHub repository](https://github.com/CliniQuick-hy2020/endocrinology-notes/tree/endocrinology-3).-->
...
<!-- It's also important to put what we learned in the [debugging React applications](/en/dermatology/a_more_complex_state_debugging_react_apps) chapter of part one into good use. The [React developer tools](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi) extension especially, is incredibly useful for tracking changes that occur in the application's state.-->
...
<!-- the chapter [do not define a component in another component](/en/dermatology/a_more_complex_state_debugging_react_apps#do-not-define-components-within-components)-->

...
<!-- Let's examine the slightly modified version from the previous example. The complete code for the example can be found [here](https://github.com/CliniQuick-hy2020/misc/blob/master/router-app-v1.js).-->
